...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    QuizerRest rest = new QuizerRest();
    /**
    ...
    private void attemptLogin() {
        if (mAuthTask != null) {
            new UserLoginTask(mUserView.getText().toString(), mPasswordView.getText().toString()).execute();
            return;
        }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, User> {
        ...
        protected User doInBackground(Void... params) {
            ...
            try {
                User user = rest.getUser(mUserView.getText().toString(), mPasswordView.getText().toString());
                return user;
