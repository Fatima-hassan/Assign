...
public class QuizBo {
    ...
    public List<Quiz> getQuizes(){
        ...
        ResponseEntity<Quiz[]> quizes = restTemplate.getForEntity( REST_SERVICE_URI+"/quiz/show/" , Quiz[].class);
    ...
    public Quiz addQuiz(String title, String description) {
        ...
        Quiz quiz_with_id = restTemplate.postForObject( REST_SERVICE_URI+"/quiz/add/" , quiz , Quiz.class);
